...
def generate_launch_description():
    ...
    params_file_dec = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(get_package_share_directory('fire_detector'),'config','fire_detector_params_example.yaml'),
        description='Full path to params file for all fire_detector nodes.')
